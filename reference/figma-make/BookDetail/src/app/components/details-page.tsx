import svgPaths from "../../imports/Details/svg-6u4bx1v7h9";
import imgHead from "../../imports/Details/bdc20ccc98ab52675df59e7408596c12e994f9b2.png";
import imgBook from "../../imports/Details/5cb65d4db8502f46607eb2b01399f29ad28841e3.png";
import BorderFont3 from "../../imports/BorderFont3";
import Button2 from "../../imports/Button-2";
...
function ButtonItem({ label }: { label: string }) {
  return (
    <div className="border border-black relative size-full shrink-0">
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[108px]">
      <ButtonItem label="基核技术站" />
      <ButtonItem label="择览资料站" />
    </div>
  );
}
...
function Borderline() {
  const tiles = Array.from({ length: 47 });
  return (
    <div className="flex h-[12px] items-center justify-center relative shrink-0 w-[564px]" data-name="Borderline">
      <div className="flex-none rotate-90">
        <div className="flex flex-col w-[12px]">
          {tiles.map((_, i) => (
            <div key={i} className="relative size-[12px]" style={{ containerType: "size" }}>
              <BorderFont3 />
            </div>
          ))}
        </div>
